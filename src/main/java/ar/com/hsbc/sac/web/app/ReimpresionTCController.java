...
@RestController
@RequestMapping("/reimpresionTC")
public class ReimpresionTCController {
    ...
    private void setCards() {
            cards[0] = CardDTO.builder().numero("4697240000182586").nombres("SSS, RRR")
                            ...
                            .tipo("Titular").codigoAdmin("7").estado("OPERATIVA")
                            .build();
            ...
            motivoDto[0] = MotivoDTO.builder().codigo("2").descripcion("Apellido/s y/o Nombre/s del Socio").build();
            motivoDto[1] = MotivoDTO.builder().codigo("6").descripcion("Destruccion o Deterioror").build();
            motivDto.put("DNI10266305", motivoDto);
    ...
    public ResponseEntity<Transaccional> getCards(@RequestParam("operationId") String operationId,
            ...
            if (enquireCard.containsKey(documento)) {
                    transacc = Transaccional.builder().cards(Arrays.asList(enquireCard.get(documento)))
                                    ...
                                    .motivoDto(Arrays.asList(motivDto.get(documento)))
